...
<body onLoad="init()" oncontextmenu=self.event.returnValue=false>
    ...
    <div id="welcome" class="SHADE BOX-M">
        ...
        <div class="FILL BOX-M" style="position:absolute;top:0;left:0;right:0;bottom:0;z-index:5;">
			...
			<a data-i18n="img-before1" type="button" class="btn text-nowrap btn-secondary me-1" onclick="getClickBefore1Image()" style="left: 0">IMG-BEFORE1-I18N</a>
                        <input type="file" id="click-before1-image" accept="image/*" class="d-none" onchange="saveClickBefore1Image()">
